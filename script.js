...
const campoCopiado = document.querySelector('.mensagem');

btnCopiar.addEventListener('click', (e) => {
    
    navigator.clipboard.writeText(campoCopiado.value);
    alert('Texto Copiado com sucesso! Clique CTRL+V para colar');
}
)
